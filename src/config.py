...
INTERVAL_ALL = 60      # force sending all information at 5 m interval
INTERVAL_SIM = 10        # seconds betwen packets sent by simulator
...
broker = {'server': '192.168.3.17', 'port': '1883', 'user': 'sensor', 'password': 'SensorPassport'}
